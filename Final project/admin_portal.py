...
#Header Images:
photo_3 = CTkImage(Image.open("image_3.png"), size=(920, 200))
photo_label_3 = CTkLabel(window, image=photo_3, text=" ")
photo_label_3.grid(row=0, column=0, columnspan=2, sticky="nw")

photo_4 = CTkImage(Image.open("image_4.png"), size=(920, 200))
photo_label_4 = CTkLabel(window, image=photo_4, text=" ")
photo_label_4.grid(row=0, column=1, columnspan=1, sticky="ne")
